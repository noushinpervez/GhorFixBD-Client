    ...
    return (
        <section className="text-gray-400 bg-gray-900 body-font relative my-16">
            ...
            <div className="container px-5 py-24 mx-auto flex">
                <div className="lg:w-1/3 md:w-1/2 bg-background-50 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 text-text-950">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input
                            ...
                            id="email"
                            name="email"
                            className="w-full bg-accent-100 rounded border border-gray-700 focus:border-secondary-500 focus:ring-2 focus:ring-secondary-700 text-base outline-none text-text-800 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        />
                    </div>
                    <div className="relative mb-4">
                        ...
                        <textarea
                            id="message"
                            name="message"
                            className="w-full h-32 resize-none bg-accent-100 rounded border border-gray-700 focus:border-secondary-500 focus:ring-2 focus:ring-secondary-700 text-base outline-none text-text-800 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        ></textarea>
                    </div>
