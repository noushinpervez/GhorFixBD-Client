        ...
        <footer>
            <div className="px-4 pt-24 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="sm:col-span-2">
                        <Link href="/" aria-label="Go home" title="Scholapship Portal" className="inline-flex items-center">
                            ...
                            <h1 className="ml-2 text-xl tracking-wide font-extrabold">GhorFix</h1>
                        </Link>
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex">
                            ...
                            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 hover:text-primary-700">ghorfix@mail.com</a>
                        </div>
                    ...
                    <div className="text-gray-500 text-sm">
                        ...
                        <p className="mt-4">Thank you for visiting GhorFixBD.com</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-accent-200 lg:flex-row text-gray-600 text-sm">
                    <p>© Copyright 2024 GhorFixBD Inc. All rights reserved.</p>
